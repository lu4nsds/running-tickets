        ...
        >
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-text-muted">
                                Defina se este ingresso está disponível para
                                venda.
                            </p>
                        </div>
                    </div>
            ...
            >
                ...
                <button
                    ...
                    type="button"
                    :disabled="isSubmitting"
                    class="px-6 py-2.5 bg-primary text-background font-bold rounded-lg hover:bg-opacity-90 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(0,230,118,0.4)] hover:shadow-[0_0_30px_rgba(0,230,118,0.6)]"
                >
                    <span
                        v-if="isSubmitting"
...
const fetchTicketType = async () => {
    ...
    try {
        ...
        showToast("Erro ao carregar tipo de ingresso", "error");
        goBack();
    }
};
...
const handleSubmit = async () => {
    ...
    try {
        ...
        if (isEditMode.value) {
            ...
            await axios.post(
                `/admin/events/${eventId.value}/ticket-types`,
                payload,
            );
