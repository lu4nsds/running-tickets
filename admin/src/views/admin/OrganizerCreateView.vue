<template>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-white">Novo Organizador</h1>
            <router-link
                to="/admin/organizers"
        ...
        <form @submit.prevent="handleSubmit" class="space-y-0">
            <!-- Informações Básicas -->
            <div
                class="bg-card-bg border-x border-surface-elevated rounded-t-xl p-6 grid grid-cols-1 lg:grid-cols-3 gap-6"
            >
                <div>
                    ...
                    <p class="text-text-muted text-sm">
                        Dados principais para identificação do organizador na
                        plataforma.
                    </p>
                </div>
            ...
            <div
                class="bg-card-bg border border-surface-elevated p-6 grid grid-cols-1 lg:grid-cols-3 gap-6"
            >
                <div>
                    <h3 class="text-white font-semibold mb-1">
                        Documentação e Contato
                ...
                <div class="lg:col-span-2">
                    ...
                    >
                        <div>
                            ...
                            <p class="text-text-muted text-sm">
                                Ao ativar, o organizador poderá acessar o painel
                                e criar novos eventos.
                            </p>
                        </div>
                        <button
                            type="button"
...
const handleSubmit = async () => {
    ...
    try {
        const result = await store.createOrganizer({
            name: form.name,
        ...
        if (result.success) {
            ...
            toast.error(result.error || "Erro ao criar organizador");
        }
    } catch (err) {
