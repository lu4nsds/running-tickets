        ...
        <div class="w-full max-w-[440px] px-6 py-12 relative">
            ...
            <div class="flex flex-col items-center mb-10">
                ...
                <p class="text-gray-400 text-sm font-normal text-center">
                    Defina sua senha para acessar o Running Tickets
                </p>
            </div>
            ...
            >
                ...
                <p class="text-white font-semibold">Link de ativação inválido</p>
                <p class="text-gray-400 text-sm">
                    Este link é inválido ou está incompleto. Solicite ao administrador que te adicione novamente.
                </p>
            </div>
            ...
            >
                ...
                <div v-if="success" class="text-center space-y-4">
                    ...
                    <p class="text-white font-semibold">Conta ativada com sucesso!</p>
...
const handleActivate = async () => {
    ...
    try {
        await api.post(API_ENDPOINTS.AUTH.ACTIVATE, {
            token,
            email,
        ...
        if (err.response?.status === 422 || err.response?.status === 410) {
            ...
            if (data.errors) {
                ...
                errorMessage.value = data.message || 'Link de ativação inválido ou expirado.'
            }
        } else {
            errorMessage.value = 'Erro ao ativar conta. Tente novamente.'
        }
    } finally {
