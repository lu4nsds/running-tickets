    ...
    <main class="flex-grow">
      ...
      <section class="relative h-[500px] w-full overflow-hidden md:h-[600px]">
        ...
        >
          <div class="max-w-2xl space-y-6">
            ...
            >
              Desafie seus limites e encontre seu próximo objetivo. Milhares de
              corredores já garantiram suas vagas.
            </p>
            ...
            <div class="flex flex-col gap-4 sm:flex-row pt-4">
              ...
              >
                Ver Eventos
                <span class="material-symbols-outlined ml-2 text-xl"
                  >arrow_forward</span
                >
              </button>
            </div>
      ...
      <section class="border-y border-border-dark bg-surface-dark/50">
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div class="grid grid-cols-2 gap-8 sm:flex sm:justify-between">
            <div
            ...
            >
              ...
              <p class="text-sm font-medium text-slate-400">Inscrição Rápida</p>
            </div>
            <div
              class="flex flex-col items-center justify-center text-center sm:items-start sm:text-left"
            >
              <p class="text-3xl font-black text-white">Nordeste</p>
      ...
      <!-- Events Grid Section -->
      <section id="events" class="relative bg-background-dark py-16 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div v-for="i in 6" :key="i" class="animate-pulse">
              <div class="aspect-[16/9] bg-surface-dark rounded-2xl mb-4"></div>
              <div class="h-4 bg-surface-dark rounded w-3/4 mb-2"></div>
              <div class="h-4 bg-surface-dark rounded w-1/2"></div>
            </div>
          </div>
          ...
          <div v-else class="text-center py-16">
            <span class="material-symbols-outlined text-6xl text-slate-600 mb-4"
              >event_busy</span
            >
            <p class="text-slate-400">Nenhum evento disponível no momento.</p>
          </div>
      ...
      <section class="border-y border-border-dark bg-surface-dark py-16">
        ...
        >
          ...
          <template v-if="newsletterSubscribed">
            ...
            <div class="space-y-2">
              ...
              <p class="max-w-sm text-slate-400">
                Obrigado por se juntar a nós. Em breve você receberá nossas
          ...
          <!-- Estado: formulário -->
          <template v-else>
            <div class="rounded-full bg-primary/10 p-4 ring-1 ring-primary/20">
            ...
            <div class="space-y-2">
              ...
              <p class="max-w-2xl text-slate-400">
                Inscreva-se na nossa newsletter para receber alertas de novas
                corridas, descontos exclusivos e dicas de treino.
              </p>
            </div>
