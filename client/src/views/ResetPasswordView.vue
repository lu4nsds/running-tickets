                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="email"
                            readonly
                            class="block w-full rounded-lg border border-border-dark bg-background-dark/50 px-4 py-3 text-slate-400 cursor-not-allowed"
                        />
                    </div>
                    ...
                    <div
                        v-if="error"
                        class="text-red-400 text-sm bg-red-500/10 border border-red-500/20 rounded-lg p-3"
                    >
                        {{ error }}
                    </div>
...
onMounted(() => {
    ...
    if (!form.value.token || !form.value.email) {
        error.value = "Link de redefinição inválido. Solicite um novo link.";
    }
});
