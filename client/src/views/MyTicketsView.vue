        ...
        <main class="max-w-5xl mx-auto px-4 py-10">
            ...
            <template v-else>
                ...
                <template v-else>
                    ...
                    >
                        <p>Nenhum ingresso em "{{ activeTab === 'upcoming' ? 'Próximos Eventos' : 'Eventos Passados' }}".</p>
                    </div>
                    ...
                    <div v-else class="space-y-4">
                        ...
                        >
                            ...
                            <div class="relative flex-1 p-5 flex flex-col sm:flex-row sm:items-center gap-4">
                                ...
                                <!-- Referência do pedido + countdown da reserva (estados abertos) — fixados no rodapé do card -->
                                <div
                                    v-if="group.action.order"
                                    class="mt-2 sm:mt-0 sm:absolute sm:bottom-5 sm:left-5 text-slate-500 text-xs"
                                >
                                    <span class="mr-3 whitespace-nowrap">
                                        Ref: <span class="font-mono text-slate-400">{{ group.action.order.reference }}</span>
                                    </span>
                                    <span v-if="group.countdown" class="whitespace-nowrap text-amber-400">
                                        <svg class="w-3.5 h-3.5 inline-block align-[-0.125em] mr-1" fill="currentColor" viewBox="0 0 20 20">
