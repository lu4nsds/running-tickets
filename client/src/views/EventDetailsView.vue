                ...
                >
                    ...
                    <div class="lg:col-span-8 flex flex-col gap-10">
                        ...
                        <section id="inscricoes">
                            ...
                            >
                                <div
                                    class="flex items-center bg-surface-darker/50 rounded-xl p-1.5 border border-border-dark/50 overflow-hidden relative"
                                >
                                    <button
                                        @click="scrollCategories('left')"
                                        class="flex items-center justify-center size-8 text-slate-500 hover:text-white transition-colors z-10 shrink-0"
                                    >
                                        <svg
                                            class="w-5 h-5"
                                            fill="currentColor"
                                    ...
                                    <div
                                        ...
                                        class="flex gap-2 overflow-x-auto hide-scrollbar scroll-smooth px-2 relative py-1 flex-grow"
                                    >
                                        <button
                                            @click="selectedCategory = null"
                                            :class="[
                                                'shrink-0 px-5 py-2.5 rounded-lg text-sm font-bold transition-all',
                                                selectedCategory === null
                                                    ? 'bg-primary text-background-dark shadow-lg shadow-primary/20'
                                                    : 'text-slate-400 hover:text-white hover:bg-surface-dark border border-transparent hover:border-border-dark',
                                            ]"
                                        >
                                            Todas
                                        </button>
